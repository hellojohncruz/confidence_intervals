...
95% confidence means that on average, 95% of the time the confidence intervals
...
On average, we are 90 % confident the population proportion lies between the confidence interval of (0.566, 0.75)
